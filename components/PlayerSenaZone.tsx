...
export const PlayerSenaZone: React.FC<PlayerSenaZoneProps> = ({ 
  ...
  return (
    <div className="flex flex-col gap-3 w-full group/sena">
      ...
      <div 
        ref={scrollRef}
        className="flex gap-6 p-8 bg-[#0F172A]/40 backdrop-blur-md rounded-[32px] border-2 border-white/5 min-h-[300px] overflow-x-auto scrollbar-hide shadow-inner relative transition-all group-hover/sena:border-white/10"
      >
